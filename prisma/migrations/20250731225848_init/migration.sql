...
CREATE TABLE "public"."UnitImage" (
    ...
    CONSTRAINT "UnitImage_pkey" PRIMARY KEY ("image_id")
);
...
-- AddForeignKey
ALTER TABLE "public"."Unit" ADD CONSTRAINT "Unit_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."Property"("property_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."PropertyImage" ADD CONSTRAINT "PropertyImage_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."Property"("property_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."UnitImage" ADD CONSTRAINT "UnitImage_unit_id_fkey" FOREIGN KEY ("unit_id") REFERENCES "public"."Unit"("unit_id") ON DELETE SET NULL ON UPDATE CASCADE;
